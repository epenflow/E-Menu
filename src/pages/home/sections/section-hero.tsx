    ...
    <ContainerLayout>
      <ContainerInnerLayout>
        ...
        <Block center className="text-center">
          <Heading level={1}>
            Modern Digital Menu for Modern Restaurants
          </Heading>
          <Text>
            Streamline ordering, boost sales, and enhance customer experience
            with our intuitive e-menu system.
          </Text>
        </Block>
        ...
        <Block className="flex-row items-center gap-5 flex-wrap">
          <Text className="text-xs font-medium hidden md:block">
            ...
            <div className="-space-x-2 flex flex-row">
              <For each={["M", "E", "N", "U"]}>
                {(char, key) => (
                  <Avatar
                    key={`${key}-${char}`}
                    className="outline-2 outline-card">
